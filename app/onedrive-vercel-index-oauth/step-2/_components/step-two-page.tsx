...
import { extractAuthCodeFromRedirected, generateAuthorisationUrl } from '../../../../old/utils/oAuthHandler'
            ...
            <div className="mb-2 mt-6 text-right">
              <button
                ...
                onClick={() => {
                  ...
                  router.push(`/onedrive-vercel-index-oauth/step-3?authCode=${authCode}`)
                }}
              >
                {buttonLoading ? (
                  <>
